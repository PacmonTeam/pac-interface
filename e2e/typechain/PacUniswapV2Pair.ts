...
export interface PacUniswapV2PairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface PacUniswapV2Pair extends BaseContract {
  connect(runner?: ContractRunner | null): PacUniswapV2Pair;
  waitForDeployment(): Promise<this>;

  interface: PacUniswapV2PairInterface;
