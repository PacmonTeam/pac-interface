...
export interface PacERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface PacERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): PacERC20;
  waitForDeployment(): Promise<this>;

  interface: PacERC20Interface;
